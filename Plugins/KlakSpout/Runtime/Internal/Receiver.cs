...
sealed class Receiver : System.IDisposable
{
    ...
    public bool UseLinearTexture = true;
    ...
    public Receiver(string sourceName, bool useLinearTexture)
    {
        ...
        UseLinearTexture = useLinearTexture;
    ...
    public void Update()
    {
        ...
        if (_texture == null && data.texturePointer != IntPtr.Zero)
        {
            ...
            ((int)data.width, (int)data.height, format,
                false, UseLinearTexture, data.texturePointer);
        }
